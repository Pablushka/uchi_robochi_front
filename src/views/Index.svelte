<script>
  ...
  import Raspberries from "components/ur/Raspberries.svelte";
  import Footer from "components/Footers/Footer.svelte";

  const patternVue = "/assets/img/mazz.png";
    ...
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        ...
        <h2 class="font-semibold text-4xl text-blueGray-600">
          UCHI ROBOCHI EL MANOS EN TU PODER
        </h2>
        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
          Texto intorductorio de ayuda al usuario sobre como usar UR y todas las
          ventajhas qiue tiene esta applicacion.
          <a
            href="https://tailwindcss.com/?ref=creativetim"
            class="text-blueGray-600"
            target="_blank"
          >
            UR usa componenetes Rapsberry para automatizar acciones y tareas
          </a>
          Para poder usar UR por favor compre una RBpi
        </p>
        <div class="mt-12">
          <a
            href="https://github.com/creativetimofficial/notus-svelte?ref=ns-index"
            class="github-star ml-1 text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-emerald-500 active:bg-blueGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
            target="_blank"
          >
